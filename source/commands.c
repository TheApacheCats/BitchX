...
Mailing list is at majordomo@lists.bitchx.com\n";
	...
	put_it("[35mÛ[31;45m²[0m    [1;35;45m²[31;41m±[0m    [1;35;45m±[31;41m±[0m    [1;35;45m±[0;31;45m²[0m    [1;35;45m²[31;41m±[0m    [1;35;45m²[31;41m±[0m    [1;35;45m²[31;41m±[0m    [1;35;45m±[0;31;45m²[0m    [1;35;45m²[31;41m±[0m    [1;35;45m±[0;35;40mÛÛÛÛÛß[32mÜß[35mÜÜ[1;32mßÜÜ[0;32;40mÜ[35mßßÝ [1;45m°[0;35;40mË ÛÞ[0m");
...
{
int voice = 0, ops = 0, nops = 0, ircops = 0, all = 0, friends = 0, shit = 0;
char *channel = NULL;
ChannelList *chan;
...
int cols = get_int_var(NAMES_COLUMNS_VAR);
	...
	if (command && !my_stricmp(command, "scanv"))
		...
		nops = 1;
	else if (command && !my_stricmp(command, "scanf"))
		friends = 1;
	else if (command && !my_stricmp(command, "scans"))
		shit = 1;
